			...
			<div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img src="https://c8.alamy.com/comp/2RCK3RM/concept-of-e-learning-a-learning-management-system-through-a-network-learning-management-system-with-an-emphasis-on-learners-as-the-center-in-teac-2RCK3RM.jpg" height="100%" width="100%"/></div>
                            <div class="col-lg-6">
                                <div class="p-5">
